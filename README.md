...
| --- | --- | --- |
| **embedded** | otto 0.1.4 from PyPI inside the APK (Chaquopy, Python 3.13) | the release build; the compiled wheels PyPI lacks for Android come from the `wheels-cp313-otto-0.1.2` release (`wheels/`) |
